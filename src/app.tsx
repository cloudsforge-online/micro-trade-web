 ...
 * (`trade/src/server.ts:342`) makes no `authenticate()` call at all, and it carries a comment
 ...
 * verifies the bearer itself (`trade/src/server.ts:779-785`) and every owned row is filtered by
