 ...
 * (`trade/src/server.ts:334`) makes no `authenticate()` call at all, and it carries a comment
 ...
 * verifies the bearer itself (`trade/src/server.ts:714-720`) and every owned row is filtered by
