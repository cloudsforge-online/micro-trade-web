 ...
 *
 * `GET /v1/strategies` (`trade/src/server.ts:349`) makes no `authenticate()` call, so this renders
  ...
  return (
    <section className="tw-page">
      ...
      {/*
        ...
        `trade/src/server.ts:487-488` defaults a backtest to 10 basis points of fee and 5 of
