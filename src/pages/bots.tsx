 ...
 * Your bots.
 *
 * `GET /v1/bots` — `trade/src/server.ts:547`. At most 100, newest first (`:479`), the caller's own.
 *
  ...
  return (
    <section className="tw-page">
      ...
      {/*
        ...
        `trade/src/server.ts:615` defaults `feeBps` to 1500 on creation, and `trade/src/fees.ts:9-12`
